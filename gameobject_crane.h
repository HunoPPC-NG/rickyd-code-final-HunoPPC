...
#ifndef header_gameobject_crane
#define header_gameobject_crane

#if _MSC_VER > 1000
#pragma once
#endif

#define CRANE_MAX_VELOCITY 8
#define CRANE_INC_VELOCITY 2
#define CRANE_WAIT 1000
...
class GameObject_Crane : public GameObject_Moving
{
//!Enums:
public:
	enum ObjectState
...
//!Construction:
public:
	GameObject_Crane(World *world, tinyxml2::XMLElement* object_element);
	~GameObject_Crane();
	static GameObject * __stdcall Create(World *world, tinyxml2::XMLElement* object_element)
	{
		return new GameObject_Crane(world, object_element);
	}
//!Attributes:
public:
