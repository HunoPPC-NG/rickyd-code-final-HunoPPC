...
#ifndef header_gameobject_bulletpack
#define header_gameobject_bulletpack
...
class GameObject_Bulletpack : public GameObject_Moving
{
//!Enums:
public:
...
//!Construction:
public:
	//: Construct a bulletpack object
	GameObject_Bulletpack(World *world,  tinyxml2::XMLElement* object_element);
	//: Destruct a bulletpack object
	~GameObject_Bulletpack();
	static GameObject * __stdcall Create(World *world, tinyxml2::XMLElement* object_element) 
	{ 
		return new GameObject_Bulletpack(world, object_element); 
	}
//!Attributes:
public:
