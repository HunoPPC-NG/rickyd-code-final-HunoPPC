...
#ifndef header_gameobject_movingwall3
#define header_gameobject_movingwall3

#if _MSC_VER > 1000
#pragma once
#endif

#define MOVINGBLOCK3_V_VELOCITY 5
#define MOVINGBLOCK3_WAIT1 10000
#define MOVINGBLOCK3_TRIGGER_TIME 480
...
class GameObject_Movingwall3 : public GameObject_Moving
{
//!Enums:
public:
	enum ObjectState
...
//!Construction:
public:
	GameObject_Movingwall3(World *world, tinyxml2::XMLElement* object_element);
	~GameObject_Movingwall3();
	static GameObject * __stdcall Create(World *world, tinyxml2::XMLElement* object_element) 
	{ 
		return new GameObject_Movingwall3(world, object_element); 
	}
//!Attributes:
public:
