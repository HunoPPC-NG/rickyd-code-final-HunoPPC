...
/////////////////////////////////////////////////////////////////////////////
// GameObject_Wagon construction:

GameObject_Wagon::GameObject_Wagon(World *world, tinyxml2::XMLElement* object_element) :
	GameObject_Moving(world)
{
	set_STATE(waiting1);
	set_type(wall);

	spr_object[active] = new RE_Sprite(world->gc, "global/objects/wagon/active/anim/sprite", world->global_resources);

	sfx_moving = new RE_SoundBuffer("global/objects/wagon/sounds/moving/sample", world->global_resources);
	...
	def_max_velocity = WAGON_MAX_VELOCITY;
	def_inc_velocity = WAGON_INC_VELOCITY;
	def_wait_time = WAGON_WAIT;
...
GameObject_Wagon::~GameObject_Wagon()
{
...
/////////////////////////////////////////////////////////////////////////////
// GameObject_Wagon attributes:

/////////////////////////////////////////////////////////////////////////////
// GameObject_Wagon operations:
void GameObject_Wagon::set_trigger_box(int tb_x, int tb_y, int tb_width, int tb_height)
{
	TriggerBox = new RE_Rect(tb_x, tb_y - tb_height, tb_x + tb_width, tb_y);
}

bool GameObject_Wagon::check_trigger()
{
...
void GameObject_Wagon::update_STATE()
{
...
void GameObject_Wagon::set_STATE(ObjectState state, bool final)
{
	if(state == waiting2)
	{
		wait_time1 = def_wait_time;
...
void GameObject_Wagon::update_collision_box()
{
	tinyxml2::XMLElement* cb_element = world->global_resources->getElement("global/objects/wagon/active/collision_box");
...
bool GameObject_Wagon::turn(int time_elapsed)
{
	update_STATE();
...
void GameObject_Wagon::show(int view_x, int view_y)
{
