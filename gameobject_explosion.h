...
#ifndef header_gameobject_explosion
#define header_gameobject_explosion
...
class GameObject_Explosion : public GameObject_Moving
{
//!Enums:
public:
	enum ObjectState
...
//!Construction:
public:
	GameObject_Explosion(World *world, tinyxml2::XMLElement* object_element);
	~GameObject_Explosion();
	static GameObject * __stdcall Create(World *world, tinyxml2::XMLElement* object_element)
	{
		return new GameObject_Explosion(world, object_element);
	}
//!Attributes:
public:
